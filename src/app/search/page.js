...
// import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components/ui/tabs"
// import { Search, ChevronDown, GraduationCap, MapPin, School } from "lucide-react"
// import data from "../components/data.js"
...
//   // Initialize search parameters from URL (if any)
//   const [courseInput, setCourseInput] = useState(searchParams.get("course") || "")
...
//   useEffect(() => {
//     if (selectedDestination) {
//       const country = data.find((item) => item.cn.toLowerCase() === selectedDestination.replace(/-/g, " "))
//       setCurrentCountryCourses(country ? country.cr : [])
//     } else {
//       setCurrentCountryCourses([])
//     }
...
//                               value={destination.value}
//                               onSelect={(currentValue) => {
//                                 setSelectedDestination(currentValue === selectedDestination ? "" : currentValue)
//                                 setOpenDestination(false)
//                               }}
//                             >
//                               <span className="mr-2">{destination.flag}</span>
...
//                     >
//                       <School className="h-5 w-5 mr-1 text-gray-400" />
//                       {selectedDegree ? degreeTypes.find((d) => d.value === selectedDegree)?.name : "Select degree"}
//                       <ChevronDown className="h-4 w-4 ml-1 opacity-50" />
//                     </Button>
//                   </PopoverTrigger>
//                   <PopoverContent className="w-full p-0" align="start">
...
//                               value={degree.value}
//                               onSelect={(currentValue) => {
//                                 setSelectedDegree(currentValue === selectedDegree ? "" : currentValue)
//                                 setOpenDegree(false)
//                               }}
//                             >
//                               {degree.name}
...
//                 {/* Search button */}
//                 <Button onClick={handleSearch} size="sm" className="ml-2 bg-blue-600 hover:bg-blue-700">
//                   <Search className="h-4 w-4" />
//                 </Button>
//               </div>
//             </div>
...
//           </TabsTrigger>
//         </TabsList>
//         <TabsContent value="courses">{/* Render your course search results here */}</TabsContent>
//         <TabsContent value="universities">{/* Render your university search results here */}</TabsContent>
//       </Tabs>
//     </main>
//   )
// }
