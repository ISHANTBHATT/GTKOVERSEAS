...
export const StickyScroll = ({ content, contentClassName }) => {
  ...
  const ref = useRef(null);
  const { scrollYProgress } = useScroll({
    // Track the component's position in the viewport during page scroll
    target: ref,
    offset: ["start start", "end start"],
  });
  const cardLength = content.length;
  ...
  const backgroundColors = ["#8A0206", "#8A0206", "#8A0206"];
  const linearGradients = [
...
//       }}
//       className={cn(
//         "relative flex h-[30rem] justify-center gap-10 overflow-y-auto rounded-md p-10",
//         activeCard % 2 !== 0 && "flex-row-reverse"
//       )}
//       ref={ref}
//     >
//       <div className="relative flex items-start px-4">
...
//     linearGradients[0]
//   );
//   const imageWidth = 400; // w-80 in pixels
...
//         animate={{
//           x: activeCard % 2 === 0 ? 0 : imageWidth + gap,
//         }}
...
//         backgroundColor: backgroundColors[activeCard % backgroundColors.length],
//       }}
//       className="relative flex h-full justify-center space-x-10 rounded-md p-10"
//       ref={ref}
//     >
//       {/* Text Content - now in a flex column with dynamic alignment */}
//       <div className="relative flex items-start px-4">
...
//       {/* Image Container with dynamic translation */}
//       <motion.div
//         style={{ background: backgroundGradient }}
//         className={cn(
...
//         )}
//         animate={{
//           x: activeCard % 2 === 0 ? 0 : "calc(-100% - 40px)",
//         }}
//         transition={{ type: "spring", stiffness: 100, damping: 20 }}
//       >
//         {content[activeCard]?.content ?? null}
